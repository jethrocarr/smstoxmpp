...
#
# This script checks the current version of the database for the SMStoXMPP application
...
if ($help)
{
	print "SMStoXMPP Schema Management Utility\n";
	print "\n";
	print "Usage: schema_manage.pl --schemadir=<schemadir>\n";
	print "\n";
	print "-c, --cfgfile=FILENAME            SMStoXMPP configuration file with MySQL settings.\n";
	print "\n";
