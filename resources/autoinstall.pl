...
my $db_name		= "smstoxmpp";	# name of the DB to create
my $db_host		= "localhost";		# MySQL server

my $db_bs_user		= "smstoxmpp";	# name of the aoconf user to create
my $db_bs_password	= random_password(10);	# random password to generate

# location of config.php file
my $opt_cfgfile = "/etc/smstoxmpp/config.php";

# tmp file to use for SQL query generation
my $opt_tmpfile = "/tmp/smstoxmpp_mysqlquery";
...
print "\n";
print "This script setups the SMStoXMPP database components:\n";
print " * SMStoXMPP MySQL user\n";
print " * SMStoXMPP database\n";
print " * SMStoXMPP configuration files\n";
print "\n";
print "THIS SCRIPT ONLY NEEDS TO BE RUN FOR THE VERY FIRST INSTALL OF SMStoXMPP.\n";
...
print "\n";
print "You can now login with the default username/password of setup/setup123 at http://localhost/smstoxmpp\n";
print "\n";
